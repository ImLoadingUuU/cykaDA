...
class $3ed269f2f0fb224b$export$2e2bcd8739ae039 extends $4040acfd8584338d$export$2e2bcd8739ae039 {
    ...
    drop(e) {
        ...
        if (files.length) {
            ...
            if (items && items.length && items[0].webkitGetAsEntry != null) // The browser supports dropping of folders, so handle components instead of files
    ...
    // When a folder is dropped (or files are pasted), components must be handled
    // instead of files.
